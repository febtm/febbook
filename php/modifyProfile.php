...
$sql_query_2 = "SELECT * FROM profile WHERE email like '$email' AND '$email' != '$oldemail';";

$result_2 = mysqli_query($con,$sql_query_2);


$sql_query_3 = "SELECT password FROM profile WHERE email like '$oldemail' AND password = '$oldpassword';";
