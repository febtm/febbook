...
public class Messenger extends AppCompatActivity {
    ...
    private void getInitialChatRooms() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,
                EndPoints.GET_ALL_CHAT_ROOMS + basicFunctions.getUser_id() + "&index=" + 0, new Response.Listener<String>() {
    ...
    private void getMoreChatRooms(int index) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,
                EndPoints.GET_ALL_CHAT_ROOMS + basicFunctions.getUser_id() + "&index=" + index, new Response.Listener<String>() {
