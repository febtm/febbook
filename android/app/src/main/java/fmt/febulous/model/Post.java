...
public class Post implements Serializable {
    ...
    private static int total, temp_total;


    private String id, image, title, description, type, timestamp, username, userimage, usercourse, usertype;


    private String temp_id, temp_image, temp_title,
            temp_description, temp_type, temp_timestamp, temp_username, temp_userimage, temp_usercourse, temp_usertype;
