...
public class SignIn extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    String si_email, si_username, si_password, si_course, si_usertype;
    ...
    public void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(si_username)) {
                    ...
                    if(basicFunctions.isConnectingToInternet()) {
                        ...
                        signinBackgroundTask.execute(method, si_username, si_email, si_password, si_usertype, si_course);
        ...
        B_SIGNIN_TERMS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DownloadFileFromURL().execute(EndPoints.FILE_URL + "FebulousT&C.pdf");
            }
        });
    ...
    private class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                OutputStream output = new FileOutputStream("/sdcard/" + "FebulousT&C.pdf");
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            Toast.makeText(SignIn.this, "The File has been downloaded !",Toast.LENGTH_LONG).show();
