...
public class ModifyProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CB_C_SHOW = (CheckBox) findViewById(R.id.ep_c_show_password);
        CB_N_SHOW = (CheckBox) findViewById(R.id.ep_n_show_password);
        CB_CN_SHOW = (CheckBox) findViewById(R.id.ep_cn_show_password);
        ...
        user_type.setDropDownViewResource(R.layout.activity_signin_spinner);

        user_course = new ArrayAdapter<>(
                this, R.layout.activity_signin_spinner, basicFunctions.USERCOURSE
        );

        user_course.setDropDownViewResource(R.layout.activity_signin_spinner);
